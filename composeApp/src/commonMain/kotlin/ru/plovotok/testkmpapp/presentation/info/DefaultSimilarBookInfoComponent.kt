...
class DefaultSimilarBookInfoComponent(
    private val componentContext: ComponentContext,
    override val preview: BookPreview,
    private val onGoBack: () -> Unit,
    private val onSimilar: (preview: BookPreview) -> Unit
): SimilarBookInfoComponent, ComponentContext by componentContext, ViewModelFactoryProvider {

    private val vm = getViewModel { vmFactory.createBookInfoViewModel(book = preview) }

    override val state: Value<SimilarBookInfoComponent.BookState> = vm.state
